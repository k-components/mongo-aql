...
module.exports = require('./lib/query-builder.cjs');
module.exports.neighbors = require('./lib/query-builder-graph.cjs').neighbors;
module.exports.edge = require('./lib/query-builder-graph.cjs').edge;
